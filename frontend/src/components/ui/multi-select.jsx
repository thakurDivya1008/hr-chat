      ...
      >
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              " flex w-full p-0 rounded-md border min-h-10 h-auto items-center justify-between bg-inherit hover:bg-inherit",
              className
            )}
          >
